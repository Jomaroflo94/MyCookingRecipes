...
internal sealed class UnitConfiguration : IEntityTypeConfiguration<Unit>
{
    public void Configure(EntityTypeBuilder<Unit> builder)
    {
        ...
        builder.Property(t => t.Name).IsRequired().HasMaxLength(50).HasColumnName(nameof(Unit.Name).ToLower());
        builder.Property(t => t.Symbol).IsRequired().HasMaxLength(10).HasColumnName(nameof(Unit.Symbol).ToLower());
